...
import random
# from app.config import StagingConfig as conf

flask_app= create_app('staging')
#self, lat, lon, depth, num_stas, time, amplitude=None, catalog_version=None
    ...
    for month in range(1,10):
        for day in range(1,28):
            ...
            for _ in range(num):
                ...
                e = Event(lat,lon,depth,num_stas,time,amplitude,catalog_version)
                e.save()
